...
#define ANALYTICS_EVENT_NAME_GALLERY_ADD_ITEM_FAILED @"Gallery Add Item Failed"
...
#define ANALYTICS_EVENT_NAME_CART_UPDATE_FAILED @"Gallery Add Update Failed"
#define ANALYTICS_EVENT_NAME_CART_ADD_PRINT_FAILED @"Cart Add Print Failed"
