Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/artlabs/ARTSDK'
  s.source       = { :git => "https://github.com/artlabs/ARTSDK.git", :tag => "0.0.1" }
  s.source_files = ['ARTSDK','thirdparty/nimbus/src/core/src', 'thirdparty/nimbus/src/networkimage/src']
  s.resource_bundles = { 'ArtAPI' => ['Resources/*.png', 'ARTSDK/*.xib']}
  s.license		   = {
    :type => 'MIT',
    :file => 'LICENSE'
  }
